...
class WC_Sinic_Admin {
    ...
    public function includes(){
        require_once 'menus/class-wc-sinic-page-default.php';
        require_once 'menus/class-wc-sinic-menu-default-basic.php';
    }
    ...
    /**
     * 获取注册的菜单
     * @return []Abstract_WC_Sinic_Settings_Page
     * @since 1.0.0
     */
    public function get_admin_pages(){
        return apply_filters('woo_ch_admin_pages', array(
           50=> WC_Sinic_Page_Default::instance()
        ));
    }
  
    
    /**
     * @return NULL|Abstract_WC_Sinic_Settings_Page
     * @since 1.0.0
     */
    public function get_current_page(){
        ...
        $page_id = isset($_GET['page'])?sanitize_key($_GET['page']):null;
        return WC_Sinic_Helper_Array::first_or_default($this->get_admin_pages(),function($m,$pid){
    ...
    /**
     * 
     * @return NULL|Abstract_WC_Sinic_Settings
     * @since 1.0.0
     */
    ...
    public function admin_menu(){
        ...
        $menu_title = apply_filters('woo_ch_admin_menu_title', __('WC China Checkout',WC_SINIC));
        ...
        $capabilitys = apply_filters('woo_ch_manager_capabilitys', array('administrator'));
        ...
        foreach ($pages as $page){
            if(!$page||!$page instanceof Abstract_WC_Sinic_Settings_Page){
                continue;
            }
