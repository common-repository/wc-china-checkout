 ...
 * @author ranj
 */
abstract class Abstract_WC_Sinic_Settings_Menu extends Abstract_WC_Sinic_Settings{  
    /**
     * 获取菜单链接
    ...
    public function get_submenu(){
        $current= isset($_GET['sub'])?WC_Sinic_Helper_String::sanitize_key_ignorecase(trim($_GET['sub'])):'';
    ...
    public function render($page){
        $view = new WC_Sinic_Menu_View($page,$this);
        $view->render();
    }
}
 ...
 * @since 1.0.0
 */
class WC_Sinic_Menu_View extends WC_Sinic_View_Form{
    /**
     * 一级菜单
     * @var Abstract_WC_Sinic_Settings_Menu
     * @since 1.0.0
     */
    private $menu;
     ...
     * 二级菜单
     *
     * @var Abstract_WC_Sinic_Settings
     * @since 1.0.0
     */
    private $submenu;
    /**
     ...
     * 
     * @param Abstract_WC_Sinic_Settings_Page $page
     * @param Abstract_WC_Sinic_Settings_Menu $menu
     */
    ...
    /* (non-PHPdoc)
     * @see WC_Sinic_SHOP_View::sub_menus()
     */
    ...
    /* (non-PHPdoc)
     * @see WC_Sinic_SHOP_View::process_admin_options()
     */
    ...
    /* (non-PHPdoc)
     * @see WC_Sinic_SHOP_View::content()
     */
